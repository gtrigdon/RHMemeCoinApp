...
contract RigdonhouseMemeCoin is ERC20, Ownable, ERC20Burnable {
    ...
    event newOwnershipTransfer(address newOwner);

    constructor() ERC20("FroJaxCoin", "FJX") {
    ...
    function transferOwnership(address newOwner) public override onlyOwner {
        ...
        emit newOwnershipTransfer(newOwner);
    }
}